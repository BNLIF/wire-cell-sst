...
namespace WireCellSst {
     ...
     */
    class DatauBooNEFrameDataSource_afterHF : public WireCell::FrameDataSource {
      ...
      DatauBooNEFrameDataSource_afterHF(const char* root_file, const WireCell::GeomDataSource& gds,int bins_per_frame1 = 9600, int flag_add_noise = 0);
	DatauBooNEFrameDataSource_afterHF(const TH2F *hu_raw, const TH2F *hv_raw, const TH2F *hw_raw, TTree *T_bad, TTree *T_lf, TTree *Trun, const WireCell::GeomDataSource& gds);
