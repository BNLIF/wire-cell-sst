...
Double_t PoissonReal2(const Double_t *k,  const Double_t *lambda) {
...
void WireCellSst::SimulationuBooNEFrameDataSource::Simu_Noise_uBooNE_Empirical(TH1F *h1, Int_t plane, Int_t channel){
  ...
  TF1 *MyPoisson = new TF1("MyPoisson", PoissonReal2,0.,MaxPoissArg,1);
    ...
    , hm_2us(0)
{
  ...
  TF1 *f1 = new TF1("func1",response2,0,10,2);
  TF1 *f2 = new TF1("func2",response2,0,10,2);
...
void WireCellSst::SimulationuBooNEFrameDataSource::RemovePMTSignalInduction(TH1F* hist, int start_bin, int end_bin){
  int pad_window = 5;
...
void WireCellSst::SimulationuBooNEFrameDataSource::RemovePMTSignalCollection(TH1F* hist, float rms, int channel){
