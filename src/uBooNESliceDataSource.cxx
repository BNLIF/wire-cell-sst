...
WireCellSst::uBooNESliceDataSource::uBooNESliceDataSource(FrameDataSource& fds, float th)
    : _fds(fds)
    , _fds1(fds)
    , _frame_index(-1)
    , _slice_index(-1)
...
void WireCellSst::uBooNESliceDataSource::set_flag(int flag1){
  flag = flag1;
}

WireCellSst::uBooNESliceDataSource::uBooNESliceDataSource(FrameDataSource& fds, FrameDataSource& fds1, float th_u, float th_v, float th_w, float th_ug, float th_vg, float th_wg, int nwire_u, int nwire_v, int nwire_w, std::vector<float>* uplane_rms, std::vector<float>* vplane_rms, std::vector<float>* wplane_rms)
    : _fds(fds)
    , _fds1(fds1)
    , _frame_index(-1)
    , _slice_index(-1)
...
WireCellSst::uBooNESliceDataSource::uBooNESliceDataSource(const DetectorGDS& gds, FrameDataSource& fds, FrameDataSource& fds1, float th_u, float th_v, float th_w, float th_ug, float th_vg, float th_wg, int nwire_u, int nwire_v, int nwire_w, std::vector<float>* uplane_rms, std::vector<float>* vplane_rms, std::vector<float>* wplane_rms)
    : _fds(fds)
    , _fds1(fds1)
    , _frame_index(-1)
    , _slice_index(-1)
